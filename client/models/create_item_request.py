...
if TYPE_CHECKING:
    from .create_item_request_item import CreateItemRequest_item
...
class CreateItemRequest(AdditionalDataHolder, Parsable):
    ...
    # The item property
    item: Optional[CreateItemRequest_item] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> CreateItemRequest:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "item": lambda n : setattr(self, 'item', n.get_object_value(CreateItemRequest_item)),
        }
        return fields
