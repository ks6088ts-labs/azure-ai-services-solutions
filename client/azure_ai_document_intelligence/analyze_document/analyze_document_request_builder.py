...
class Analyze_documentRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /azure_ai_document_intelligence/analyze_document
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/azure_ai_document_intelligence/analyze_document", path_parameters)
