...
if TYPE_CHECKING:
    ...
    from ...models.delete_queue_request import DeleteQueueRequest
...
class QueuesRequestBuilder(BaseRequestBuilder):
    ...
    async def delete(self,body: Optional[DeleteQueueRequest] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeleteQueueResponse]:
        """
        Delete Queue
    ...
    def to_delete_request_information(self,body: Optional[DeleteQueueRequest] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Delete Queue
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
